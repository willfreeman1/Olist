...
full_df <- readRDS("C:\\Users\\willf\\OneDrive\\Documents\\NYDSA\\R\\Olist\\Data\\full_df.rds")
...
# rename code_tract.x to code_tract in full_df_joined
full_df_joined = full_df_joined %>%
  rename(code_tract = code_tract.x)


full_censo_df = full_df_joined %>%
  left_join(tracts_percap, by = "code_tract")
```
