...
# We have sellers new old in geo_df_delivered
...
# Merge datasets
revenue_sellers_df = left_join(monthly_revenue_pxq, monthly_sellers, by = "month") %>%
  mutate(
    avg_revenue_payment = total_payment_value / total_sellers, 
    avg_revenue_calc = total_revenue / total_sellers
  )
...
filtered_seller_indexes = filtered_seller_df %>%
  mutate(
    ...
    sellers_index = (total_sellers / base_total_sellers) * 100,
...
# Output the data for manual inspection
print(revenue_sellers_df)
