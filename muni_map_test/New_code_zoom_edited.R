...
getGlobalBinRanges <- function(func_datatype_input, func_aggregation_input, func_metric_input) {
  ...
  if (func_datatype_input == "seller" & 
    ...
    bin_info$bin_ranges <- list(c(0, 25000), c(25000, 100000),  c(100000, 200000),c(200000, 500000), c(500000, 1000000), c(1000000, 3000000) )
...
#choices for third level (no information on zip or state for seller)
