...
str(final_geo_df)
getwd()
final_geo_df = readRDS("..\\R_Analysis\\final_geo_df.rds")
```
...
estimated_size <- object.size(final_geo_df_geom)
...
```
```{r}
# Simplify final_geo_df_geom to make it smaller

# First make all the columns valid
final_geo_df_geom$geom_tracts <- st_make_valid(final_geo_df_geom$geom_tracts)
final_geo_df_geom$geom_munis <- st_make_valid(final_geo_df_geom$geom_munis)
final_geo_df_geom$geom_states <- st_make_valid(final_geo_df_geom$geom_states)


# Then simplify
final_geo_df_geom$geom_tracts <- st_simplify(final_geo_df_geom$geom_tracts, dTolerance = 0.01)
final_geo_df_geom$geom_munis <- st_simplify(final_geo_df_geom$geom_munis, dTolerance = 0.01)
final_geo_df_geom$geom_states <- st_simplify(final_geo_df_geom$geom_states, dTolerance = 0.01)

```

```{r}
str(final_geo_df_geom)


# Save final_geo_df_geom as RDS file
saveRDS(final_geo_df_geom, "final_geo_df_geom.rds")
```
